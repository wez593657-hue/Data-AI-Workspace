...
BEGIN
    ...
    -- 步骤 2: 日志开始
    -- ====================
    RAISE NOTICE '存储过程 pro_ads_cust_new_cust_statis 开始执行';
    RAISE NOTICE '目标表: ads_cust_new_cust_statis (ADS层)';
    ...
    BEGIN
        ...
        INSERT INTO ads_cust_new_cust_statis (
            ...
            p_new_cust_cnt,
            p_cntct_cust_cnt,
            p_asset_bal_seg1_cust_cnt,
            p_asset_bal_seg2_cust_cnt,
            p_asset_bal_seg3_cust_cnt,
            p_asset_bal_seg4_cust_cnt,
            p_asset_bal_seg5_cust_cnt,
            p_cntct_rate,
            p_kyc_cust_cnt,
            p_comp_rate,
            NOW(),
    ...
    RAISE NOTICE '存储过程 pro_ads_cust_new_cust_statis 执行完成';
