...
BEGIN
    ...
    -- 步骤 2: 日志开始
    -- ====================
    RAISE NOTICE '存储过程 pro_ads_cust_lost_statis 开始执行';
    RAISE NOTICE '目标表: ads_cust_lost_statis (ADS层)';
    ...
    RAISE NOTICE '存储过程 pro_ads_cust_lost_statis 执行完成';
