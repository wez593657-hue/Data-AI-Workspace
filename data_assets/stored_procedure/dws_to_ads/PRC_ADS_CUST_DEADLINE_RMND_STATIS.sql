...
BEGIN
  ...
  SELECT d.PERSN_LEGAL_BK_CODE,
         ...
         NVL(d.FIX_DEPO_MATURE_AMT, 0),
         NVL(d.FIX_DEPO_MATURE_TTL_AMT, 0),
         NVL(d.FIX_DEPO_TAKE_RATE, 0)
  ...
  SELECT b.PERSN_LEGAL_BK_CODE,
         ...
         b.FIX_DEPO_MATURE_AMT, b.FIX_DEPO_MATURE_TTL_AMT, b.FIX_DEPO_TAKE_RATE
  ...
  INSERT INTO ADS_CUST_DEADLINE_RMND_STATIS (
      ...
      FIX_DEPO_EXPR_AMT, FIX_DEPO_TTL_EXPR_AMT, FIX_DEPO_UNDTAKE_RATE
  )
  SELECT s.PERSN_LEGAL_BK_CODE,
         ...
         END,
         SUM(s.FIX_DEPO_MATURE_AMT),
         SUM(s.FIX_DEPO_MATURE_TTL_AMT),
         CASE WHEN SUM(s.FIX_DEPO_MATURE_AMT) = 0 THEN 0
              ELSE ROUND(SUM(s.FIX_DEPO_MATURE_AMT * s.FIX_DEPO_TAKE_RATE / 100) / SUM(s.FIX_DEPO_MATURE_AMT) * 100, 2)
         END
