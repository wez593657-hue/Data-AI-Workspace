CREATE OR REPLACE PROCEDURE pro_ads_mkt_act_tsk_mon(
...
BEGIN
    ...
    -- 步骤 2: 日志开始
    -- ====================
    RAISE NOTICE '存储过程 pro_ads_mkt_act_tsk_mon 开始执行';
    RAISE NOTICE '目标表: ads_mkt_act_tsk_mon (ADS层)';
    ...
    BEGIN
        -- 插入数据
        INSERT INTO ads_mkt_act_tsk_mon (
            data_date,
            stat_obj,
            mkt_act_id,
            cust_cnt,
            ctkt_cover_rate,
            plan_support_cust_cnt,
            further_mkt_cust_cnt,
            not_support_cust_cnt,
            mkt_success_rate,
            create_time,
            update_time,
            create_by,
            ...
            p_cust_cnt,
            p_ctkt_cover_rate,
            p_plan_support_cust_cnt,
            p_further_mkt_cust_cnt,
            p_not_support_cust_cnt,
            p_mkt_success_rate,
            NOW(),
            NOW(),
            CURRENT_USER,
    ...
    RAISE NOTICE '存储过程 pro_ads_mkt_act_tsk_mon 执行完成';
