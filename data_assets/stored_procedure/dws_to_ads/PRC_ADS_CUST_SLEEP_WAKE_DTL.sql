...
BEGIN
  ...
  UPDATE TMP_ADS_SLEEP_WAKE_BASE b
     SET (b.DEPO_CURNT_DEPO_BAL, b.FIXD_DEPO_BAL, b.FIN_AMT, b.INSUR_AMT,
         ...
         (SELECT NVL(a.DEPO_CURNT_DEPO_BAL, b.DEPO_CURNT_DEPO_BAL),    -- 活期(保留遗值)
                 NVL(a.FIXD_DEPO_BAL, b.FIXD_DEPO_BAL),                -- 定期
                 NVL(a.FIN_BAL, b.FIN_AMT),                             -- 理财
                 NVL(a.INSUR_BAL, b.INSUR_AMT),                         -- 保险
