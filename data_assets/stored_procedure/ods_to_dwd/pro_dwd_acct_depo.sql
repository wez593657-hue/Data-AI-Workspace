CREATE OR REPLACE PROCEDURE pro_dwd_acct_depo(
...
BEGIN
    ...
    -- 步骤 2: 日志开始
    -- ====================
    RAISE NOTICE '存储过程 pro_dwd_acct_depo 开始执行';
    RAISE NOTICE '目标表: dwd_acct_depo (DWD层)';
    ...
    RAISE NOTICE '存储过程 pro_dwd_acct_depo 执行完成';
