CREATE OR REPLACE PROCEDURE pro_dwd_tmp_jigou_code(
...
BEGIN
    ...
    -- 步骤 2: 日志开始
    -- ====================
    RAISE NOTICE '存储过程 pro_dwd_tmp_jigou_code 开始执行';
    RAISE NOTICE '目标表: dwd_tmp_jigou_code (DWD层)';
    ...
    RAISE NOTICE '存储过程 pro_dwd_tmp_jigou_code 执行完成';
