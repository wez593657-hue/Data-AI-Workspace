CREATE OR REPLACE PROCEDURE pro_dwd_acct_loan_his(
...
BEGIN
    ...
    -- 步骤 2: 日志开始
    -- ====================
    RAISE NOTICE '存储过程 pro_dwd_acct_loan_his 开始执行';
    RAISE NOTICE '目标表: dwd_acct_loan_his (DWD层)';
    ...
    RAISE NOTICE '存储过程 pro_dwd_acct_loan_his 执行完成';
