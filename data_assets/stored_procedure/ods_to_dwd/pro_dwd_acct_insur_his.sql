CREATE OR REPLACE PROCEDURE pro_dwd_acct_insur_his(
...
BEGIN
    ...
    -- 步骤 2: 日志开始
    -- ====================
    RAISE NOTICE '存储过程 pro_dwd_acct_insur_his 开始执行';
    RAISE NOTICE '目标表: dwd_acct_insur_his (DWD层)';
    ...
    BEGIN
        -- 插入数据
        INSERT INTO dwd_acct_insur_his (
            data_date,
            cust_id,
            cust_typ,
            acct_id,
    ...
    RAISE NOTICE '存储过程 pro_dwd_acct_insur_his 执行完成';
