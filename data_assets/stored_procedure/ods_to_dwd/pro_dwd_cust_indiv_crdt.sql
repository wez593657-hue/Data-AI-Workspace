CREATE OR REPLACE PROCEDURE pro_dwd_cust_indiv_crdt(
...
BEGIN
    ...
    -- 步骤 2: 日志开始
    -- ====================
    RAISE NOTICE '存储过程 pro_dwd_cust_indiv_crdt 开始执行';
    RAISE NOTICE '目标表: dwd_cust_indiv_crdt (DWD层)';
    ...
    RAISE NOTICE '存储过程 pro_dwd_cust_indiv_crdt 执行完成';
