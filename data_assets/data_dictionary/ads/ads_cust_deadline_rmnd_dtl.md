...
| CUST_ID | 客户编号 | VARCHAR2 | 20 | 【待确认】 | - | - | - | - | 客户编号 |
...
| STAT_PERD | 统计周期 | VARCHAR2 | 2 | 【待确认】 | - | - | - | - | 统计周期 |
| STATIS_TYP | 承接类型1-存款2-理财 | VARCHAR2 | 2 | 【待确认】 | - | - | - | - | 承接类型1-存款2-理财 |
...
| CNTCT_STATE | 接触状态 | VARCHAR2 | 1 | 【待确认】 | - | - | - | - | 接触状态 |
| UNDTAKE_STATE | 承接状态 | VARCHAR2 | 1 | 【待确认】 | - | - | - | - | 承接状态 |
...
| LAST_END_DATE | 本期最后一笔到期产品日期 | VARCHAR2 | 8 | 【待确认】 | - | - | - | - | 本期最后一笔到期产品日期 |
| POST_ID | 管户经理 | VARCHAR2 | 20 | 【待确认】 | - | - | - | - | 管户经理 |
| ORG_ID | 归属机构 | VARCHAR2 | 7 | 【待确认】 | - | - | - | - | 归属机构 |
