...
CREATE TABLE crmdm.ybt_ib_list_plat (
    ...
    plat_time varchar(6) NULL, -- 交易时间
    reverse_flag varchar(1) NULL, -- 是否冲正交易 0:否 1:是
    ori_serial varchar(35) NULL, -- 原交易流水号
    channel_id varchar(4) NULL, -- 渠道号
    service_id varchar(8) NULL, -- 交易码
    channel_serial varchar(40) NULL, -- 渠道流水号
    ...
    busi_id varchar(24) NULL, -- 业务分类编号
    acct_no varchar(32) NULL, -- 交易账号
    acct_name varchar(1020) NULL, -- 交易账号名称
    trad_type varchar(1) NULL, -- 交易类别 0:现金 1:转账 2:其他
    cry_id varchar(3) NULL, -- 交易币种(CNY，基于ISO 4217)
    amt numeric NULL, -- 交易金额
    amt1 numeric NULL, -- 辅助金额1
    amt2 numeric NULL, -- 辅助金额2
    amt3 numeric NULL, -- 辅助金额3
    ...
    plat_trad_status varchar(1) NULL, -- 平台处理状态 0预计1处理中 2处理成功 3处理失败 4已冲正
    ...
    chk_flag varchar(1) NULL, -- N 无需对账，0:未对账，1:已对账，2:已生成第三方对账文件，3:处理中
    ...
    tran_date varchar(8) NULL, -- 交易日期
    item_id varchar(40) NULL, -- 项目分类编号
    rem_amt numeric NULL, -- 剩余可退款金额
    ...
    settle_amt numeric NULL, -- 清算金额
    d_amt_sum numeric NULL, -- 借方累计金额
    c_amt_sum numeric NULL, -- 贷方累计金额
    ryzd varchar(1) NULL -- 冗余字段
);
COMMENT ON TABLE crmdm.ybt_ib_list_plat IS 'YBT_IB_LIST_PLAT';
