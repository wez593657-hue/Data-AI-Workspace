...
CREATE TABLE crmdm.cms_acct_loan (
    ...
    2) NULL,
    accruedinterest numeric(24,
    2) NULL,
    overdueinterest numeric(24,
    2) NULL,
    principalpenalty numeric(24,
    2) NULL,
    interestpenalty numeric(24,
    2) NULL,
    overduefee numeric(24,
    2) NULL,
    impairmentflag varchar(10) NULL,
    graceinteestamt numeric(24,
    2) NULL,
    ...
    lastdaynormalbalance numeric(24,
    2) NULL,
    lastdayoverduebalance numeric(24,
    2) NULL,
    lastdayaccruedinterest numeric(24,
    2) NULL,
    lastdayoverdueinterest numeric(24,
    2) NULL,
    lastdayprincipalpenalty numeric(24,
    2) NULL,
    lastdayinterestpenalty numeric(24,
    2) NULL,
    lastdayoverduefee numeric(24,
    2) NULL,
