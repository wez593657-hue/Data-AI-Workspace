...
CREATE TABLE crmdm.cds_tb_cash_acct_info (
    ...
    balance numeric(16,
    2) NULL,
    cumulative numeric(16,
    2) NULL,
    balance_pay_interest numeric(16,
    2) NULL,
    interest_no varchar(32) NULL,
    reach_avg_balance numeric(16,
    2) NULL,
    total_interest numeric(16,
    2) NULL,
    interest numeric(16,
    2) NULL,
    pay_interest numeric(16,
    2) NULL,
    sign_interest numeric(16,
    2) NULL,
    draw_interest numeric(16,
    2) NULL,
