...
class SleepWakeProcedureTests(unittest.TestCase):
    ...
    def test_month_start_rechecks_aum_and_active_transactions(self):
        self.assertIn("a2.DATA_DATE = V_DATA_DATE", DTL)
        self.assertIn("NVL(w.AUM_BAL, 0) < 100", DTL)
        self.assertIn("t.JIOYCFFS = '0'", DTL)
        self.assertIn("V_IS_MONTH_BEGIN = 'Y'", DTL)

    def test_sleep_candidate_uses_legal_entity_and_org_grain(self):
        self.assertIn("t.PERSN_LEGAL_BK_CODE = w.PERSN_LEGAL_BK_CODE", DTL)
        self.assertIn("b.PERSN_LEGAL_BK_CODE = w.PERSN_LEGAL_BK_CODE", DTL)
    ...
    def test_wake_state_is_monthly_accumulative(self):
        ...
        self.assertIn("WHEN NVL(w.IS_WAKE, 0) = 1 THEN '1'", DTL)
    ...
    def test_contact_state_is_monthly_accumulative(self):
        self.assertIn("SET b.CNTCT_STATE = '1'", DTL)
    ...
    def test_missing_daily_snapshot_does_not_overwrite_history(self):
        ...
        self.assertIn("w.CUST_ID IS NOT NULL", DTL)
        self.assertIn("w.ORG_ID = b.ORG_ID", DTL)
