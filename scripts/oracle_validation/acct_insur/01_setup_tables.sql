...
BEGIN
  FOR t IN (SELECT table_name FROM user_tables
             WHERE table_name IN (
                'YBT_YBT_POLICY_BASE_INFO','YBT_YBT_POLICY_FEE_LIST','IBP_IB_LIST_PLAT',
                'YBT_YBT_POLICY_INSURANCE_INFO','YBT_YBT_PRODUCT_INFO',
               'DWD_CUST_INDV_INFO','DWD_ACCT_INSUR')) LOOP
...
CREATE TABLE DWD_CUST_INDV_INFO (
    ...
    CERT_ID VARCHAR2(18),
    CONSTRAINT PK_DWD_CUST_INDV_INFO PRIMARY KEY (CUST_ID)
);
