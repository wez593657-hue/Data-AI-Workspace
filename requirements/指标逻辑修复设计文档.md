...
| 19 | INDX_0064 | 代发薪客户净增 | 周期内新签代发客户数 | DWD_CUST_SIGN_CTRAKT | ❌ 占位 |
| 20 | INDX_0065 | 代销业务收入 | 保险代销+理财代销收入 | DWD_ACCT_INSUR + DWD_ACCT_FIN | ❌ 占位 |
...
| 25 | INDX_0070 | 银行卡三方支付绑卡 | 绑定微信/支付宝/云闪付卡数 | mbk_cust_acct + mbk_cust_info | ⏸ 已停产 |
...
| 状态 | 数量 | 占比 | 指标编码范围 |
|------|------|------|-------------|
| ✅ 正常产出 | 17 | 50.0% | 0046-0056, 0058-0059, 0061-0063, 0067 |
| ⏸ 已停产/不产出 | 4 | 11.8% | 0066, 0070-0072 |
| ❌ 占位(0值) | 4 | 11.8% | 0057, 0060, 0064-0065 |
| ❌ 排除(本期不处理) | 9 | 26.5% | 0068-0069, 0073-0079 |

### 1.3 未开发指标详细分析

#### 1.3.1 占位指标（4个）— 阻塞原因及优先级
...
| 0064 | 代发薪客户净增 | DWD_CUST_SIGN_CTRAKT.CTRAKT_TYP的6种代发薪子类型编码值域未确认 | P1 | 需业务确认CTRAKT_TYP的具体编码值（行内代发工资/惠民惠农/省社保/市社保/国库集中支付/代发薪系统） |
| 0065 | 代销业务收入 | 保险代销收入(手续费)和理财代销收入(手续费)的字段未在DWD_ACCT_INSUR/DWD_ACCT_FIN中定义 | P2 | 需确认是否有独立的中间业务收入表，或在现有表中增加收入字段 |
